<!-- 
exemple : /services//proxy/html2canvasproxy.php?url=http://google.ca 
voir aussi /proxy/html2canvas dans api/index.php    
crée l'image ici: /igo/interfaces/navigateur/app/cache/image/
...
//setup
define('PATH', '../../interfaces/navigateur/app/cache/images');         //relative folder where the images are saved
define('PATH_PERMISSION', 0777);  //use 644 or 666 for remove execution for prevent sploits
...
*/
$maxExec =  60; #(int) ini_get('max_execution_time');
