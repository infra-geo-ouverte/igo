...
def build(config_file = None, output_file = None, options = None):
    ...
    sourceDirectory = "../public/libs/GeoExt.ux/LayerTreeBuilder"
    configFilename = "full_LayerTreeBuilder.cfg"
    outputFilename = "../public/libs/GeoExt.ux/LayerTreeBuilder/LayerTreeBuilder-build.js"
