...
define(['couche'], function(Couche) {
    ...
    */
    OSM.prototype._init = function(){
        ...
        var type = [window.location.protocol+"//tile.openstreetmap.org/${z}/${x}/${y}.png"];
        if (this.options.nom){
            switch (this.options.nom.toLowerCase()){
                case "velo":
                    type = [window.location.protocol+"//tile.opencyclemap.org/cycle/${z}/${x}/${y}.png"];
                    break;
                case "humanitaire":
                    var HOTAttribution = '© Contributions<a href="https://hot.openstreetmap.org/" target="_blank"></a> <a class="styleAttributionTable" href="http://hot.openstreetmap.org/" target="_blank"> OpenStreetMap</a> Humanitaire';
