...
define(['recherche', 'aide', 'point', 'style', 'limites'], function(Recherche, Aide, Point, Style, Limites) {
    ...
    */
    function RechercheInverseAdresse(options){
        this.options = options || {};
        this.defautOptions = $.extend({}, this.defautOptions, {
            typeRecherche:"reverse",
            titre:"Inv. Adr."
        });
    };

    RechercheInverseAdresse.prototype = new Recherche();
    RechercheInverseAdresse.prototype.constructor = RechercheInverseAdresse;
     ...
     * @returns {String} Aide
    */
    RechercheInverseAdresse.prototype.obtenirAideHTML = function() {
        return  "Ex: <br>"+
    ...
    */
    RechercheInverseAdresse.prototype.obtenirCopyright = function() {
    ...
    RechercheInverseAdresse.prototype.lireReponse = function(data, textStatus, jqXHR) {
    ...
    RechercheInverseAdresse.prototype.ajouterOccurences = function(e) {
    ...
    RechercheInverseAdresse.prototype.traiterResultatVecteur = function(vecteur, nombreResultats) {
    ...
    return RechercheInverseAdresse;
