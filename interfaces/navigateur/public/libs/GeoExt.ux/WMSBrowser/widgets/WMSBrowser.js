...
/*
 * @requires GeoExt GeoExt/widgets/Action.js
 */
...
// Ajout du MSP - paramètre spécifique 

           // Activer le Proxyhost d'OpenLayers seulement le widget WMSBrowser et pour voir les WMS externes au serveur, Nicolas G. 25 janv 2011

            url = Igo.Aide.utiliserProxy(url);
            //ajout MSP : pour supporter les appels EGL en https des WMS du MSP, puis changer l'url lors de la connexion en https, Nicolas 28 janv 2011.
            //host_apps = Igo.Aide.obtenirHoteMSP();

    // patch pour le golocpublic et ainsi ne pas acc der   tous les WMS du MSP, que les publics, soit Radarsat, bdga et adn
   //TODO: reactiver ce patch?
        /* var strPathNameHost = window.location.pathname;
    var golocmsp = "/golocmsp/";
    var golocinspq = "/inspq_icu/";
    if(( strPathNameHost.indexOf(golocmsp)> -1 ) || ( strPathNameHost.indexOf(golocinspq)> -1 ) )
    { 

    if ((url.indexOf("cog") > -1) || (url.indexOf("/hq") > -1) || (url.indexOf("=hq") > -1) || (url.indexOf("go911") > -1) || (url.indexOf("vg_") > -1) || (url.indexOf("=administrateur") > -1) || (url.indexOf("/administrateur") > -1))
    { 
	url = "http://securitepublique.gouv.qc.ca"
