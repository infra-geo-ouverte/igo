...
```xml
   ...
   url="http://geoegl.msp.gouv.qc.ca/ws/bdga.fcgi?" infoFormat="gml" />
```
...
```xml
    ...
    url="http://geoegl.msp.gouv.qc.ca/ws/adnInternetV2.fcgi?" nom="adn_station_max_public_v"
    echelleMin="4000000" />
```
...
*Exemples*
```xml
<couche titre="exemple WFS" protocole="WFS" url="http://geoegl.msp.gouv.qc.ca/ws/dpop.fcgi?" nom="dpop_criminalite_generale_v_s" />  
```
...
<navigateur titre="G.O.LOC - Données ouvertes - Gouvernement du Québec">
    ...
    <contexte id="1" mode="l" position="74.012,26.00;EPSG:4326" zoom="7"></contexte>
         <couches>
            ...
            <couche id="BDTQ" titre="BDTQ" url="http://geoegl.msp.gouv.qc.ca/ws/bdtq.fcgi"
